...
```{r, warning  = FALSE, message=FALSE, fig.cap= "Figure 1.0: Distribution of Oil Spills that occured in 2008 by county. As color gradient darkens, the number of oil spills increases per county"}
