...
### Interests
Before the outbreak of COVID-19, Dani enjoyed traveling the world with her sister Katie and friends. Their most recent roadtrip was from Lake Como, Italy to Nice, France before returning to Vienna, Austria for Katie's graduation from the University of Vienna's Master of Human Rights program. 
...
Dani also enjoys hiking, bird watching, going to the beach, cooking, and hanging out with her new dog Bennie.


### Data Science Experience

As an assistant Brand Strategist at Horizon-Next I used excel to evaluate client data and create data visualizations before pasting them into a powerpoint deck. While at Bren I have learned to use R and GitHub, and with these tools the importance of data reproducibility. Although at Horizon I used excel templates and could easily refresh the document to pull in new data, the level of reproducibility for anyone other than the two team members who created the documents was non-existent. 
Through my data science courses at Bren I have learned to use the `tidyverse` package to easily analyze data produce  visualizations. 
